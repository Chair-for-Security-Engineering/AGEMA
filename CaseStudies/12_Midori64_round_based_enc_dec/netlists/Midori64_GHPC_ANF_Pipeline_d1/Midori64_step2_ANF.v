...
module Midori64_step2_ANF #(low_latency = 0, pipeline = 1) (clk, r, in0, in1, out0, out1);
  input clk;
  input [63:0] in0, in1;
  ...
  assign s0_0[2] = g0_0[1] ^ g0_0[0] ^ g0_0[3];
  assign s0_1[2] = g0_1[1] ^ g0_1[0] ^ g0_1[3];
  ...
  assign s1_0[1] = g1_0[1];
  assign s1_1[1] = g1_1[1];
  assign s1_0[2] = g1_0[1] ^ g1_0[0] ^ g1_0[3];
  assign s1_1[2] = g1_1[1] ^ g1_1[0] ^ g1_1[3];
  assign s1_0[3] = g1_0[2] ^ g1_0[0] ^ g1_0[3];
  assign s1_1[3] = g1_1[2] ^ g1_1[0] ^ g1_1[3];
  ...
  assign s2_0[1] = g2_0[1];
  assign s2_1[1] = g2_1[1];
  assign s2_0[2] = g2_0[1] ^ g2_0[0] ^ g2_0[3];
  assign s2_1[2] = g2_1[1] ^ g2_1[0] ^ g2_1[3];
  assign s2_0[3] = g2_0[2] ^ g2_0[0] ^ g2_0[3];
  assign s2_1[3] = g2_1[2] ^ g2_1[0] ^ g2_1[3];
  ...
  assign s3_0[1] = g3_0[1];
  assign s3_1[1] = g3_1[1];
  assign s3_0[2] = g3_0[1] ^ g3_0[0] ^ g3_0[3];
  assign s3_1[2] = g3_1[1] ^ g3_1[0] ^ g3_1[3];
  assign s3_0[3] = g3_0[2] ^ g3_0[0] ^ g3_0[3];
  assign s3_1[3] = g3_1[2] ^ g3_1[0] ^ g3_1[3];
  ...
  assign s4_0[1] = g4_0[1];
  assign s4_1[1] = g4_1[1];
  assign s4_0[2] = g4_0[1] ^ g4_0[0] ^ g4_0[3];
  assign s4_1[2] = g4_1[1] ^ g4_1[0] ^ g4_1[3];
  assign s4_0[3] = g4_0[2] ^ g4_0[0] ^ g4_0[3];
  assign s4_1[3] = g4_1[2] ^ g4_1[0] ^ g4_1[3];
  ...
  assign s5_0[1] = g5_0[1];
  assign s5_1[1] = g5_1[1];
  assign s5_0[2] = g5_0[1] ^ g5_0[0] ^ g5_0[3];
  assign s5_1[2] = g5_1[1] ^ g5_1[0] ^ g5_1[3];
  assign s5_0[3] = g5_0[2] ^ g5_0[0] ^ g5_0[3];
  assign s5_1[3] = g5_1[2] ^ g5_1[0] ^ g5_1[3];
  ...
  assign s6_0[2] = g6_0[1] ^ g6_0[0] ^ g6_0[3];
  assign s6_1[2] = g6_1[1] ^ g6_1[0] ^ g6_1[3];
  assign s6_0[3] = g6_0[2] ^ g6_0[0] ^ g6_0[3];
  assign s6_1[3] = g6_1[2] ^ g6_1[0] ^ g6_1[3];
  ...
  assign s7_0[2] = g7_0[1] ^ g7_0[0] ^ g7_0[3];
  assign s7_1[2] = g7_1[1] ^ g7_1[0] ^ g7_1[3];
  assign s7_0[3] = g7_0[2] ^ g7_0[0] ^ g7_0[3];
  assign s7_1[3] = g7_1[2] ^ g7_1[0] ^ g7_1[3];
  ...
  assign s8_0[1] = g8_0[1];
  assign s8_1[1] = g8_1[1];
  assign s8_0[2] = g8_0[1] ^ g8_0[0] ^ g8_0[3];
  assign s8_1[2] = g8_1[1] ^ g8_1[0] ^ g8_1[3];
  assign s8_0[3] = g8_0[2] ^ g8_0[0] ^ g8_0[3];
  assign s8_1[3] = g8_1[2] ^ g8_1[0] ^ g8_1[3];
  ...
  assign s9_0[1] = g9_0[1];
  assign s9_1[1] = g9_1[1];
  assign s9_0[2] = g9_0[1] ^ g9_0[0] ^ g9_0[3];
  assign s9_1[2] = g9_1[1] ^ g9_1[0] ^ g9_1[3];
  assign s9_0[3] = g9_0[2] ^ g9_0[0] ^ g9_0[3];
  assign s9_1[3] = g9_1[2] ^ g9_1[0] ^ g9_1[3];
  ...
  assign s10_0[1] = g10_0[1];
  assign s10_1[1] = g10_1[1];
  assign s10_0[2] = g10_0[1] ^ g10_0[0] ^ g10_0[3];
  assign s10_1[2] = g10_1[1] ^ g10_1[0] ^ g10_1[3];
  assign s10_0[3] = g10_0[2] ^ g10_0[0] ^ g10_0[3];
  assign s10_1[3] = g10_1[2] ^ g10_1[0] ^ g10_1[3];
  ...
  assign s11_0[2] = g11_0[1] ^ g11_0[0] ^ g11_0[3];
  assign s11_1[2] = g11_1[1] ^ g11_1[0] ^ g11_1[3];
  assign s11_0[3] = g11_0[2] ^ g11_0[0] ^ g11_0[3];
  assign s11_1[3] = g11_1[2] ^ g11_1[0] ^ g11_1[3];
  ...
  assign s12_0[2] = g12_0[1] ^ g12_0[0] ^ g12_0[3];
  assign s12_1[2] = g12_1[1] ^ g12_1[0] ^ g12_1[3];
  assign s12_0[3] = g12_0[2] ^ g12_0[0] ^ g12_0[3];
  assign s12_1[3] = g12_1[2] ^ g12_1[0] ^ g12_1[3];
  ...
  assign s13_0[2] = g13_0[1] ^ g13_0[0] ^ g13_0[3];
  assign s13_1[2] = g13_1[1] ^ g13_1[0] ^ g13_1[3];
  assign s13_0[3] = g13_0[2] ^ g13_0[0] ^ g13_0[3];
  assign s13_1[3] = g13_1[2] ^ g13_1[0] ^ g13_1[3];
  ...
  assign s14_0[2] = g14_0[1] ^ g14_0[0] ^ g14_0[3];
  assign s14_1[2] = g14_1[1] ^ g14_1[0] ^ g14_1[3];
  assign s14_0[3] = g14_0[2] ^ g14_0[0] ^ g14_0[3];
  assign s14_1[3] = g14_1[2] ^ g14_1[0] ^ g14_1[3];
  ...
  assign s15_0[2] = g15_0[1] ^ g15_0[0] ^ g15_0[3];
  assign s15_1[2] = g15_1[1] ^ g15_1[0] ^ g15_1[3];
  assign s15_0[3] = g15_0[2] ^ g15_0[0] ^ g15_0[3];
  assign s15_1[3] = g15_1[2] ^ g15_1[0] ^ g15_1[3];
