...
module CRAFT_step2_ANF #(low_latency = 0, pipeline = 1) (clk, r, in0, in1, out0, out1);
  input clk;
  input [63:0] in0, in1;
  ...
  assign s8_0[2] = g8_0[0] ^ g8_0[3];
  assign s8_1[2] = g8_1[0] ^ g8_1[3];
  ...
  assign s9_0[2] = g9_0[0] ^ g9_0[3];
  assign s9_1[2] = g9_1[0] ^ g9_1[3];
  ...
  assign s10_0[2] = g10_0[0] ^ g10_0[3];
  assign s10_1[2] = g10_1[0] ^ g10_1[3];
  ...
  assign s11_0[2] = g11_0[0] ^ g11_0[3];
  assign s11_1[2] = g11_1[0] ^ g11_1[3];
  ...
  assign s12_0[2] = g12_0[0] ^ g12_0[3];
  assign s12_1[2] = g12_1[0] ^ g12_1[3];
  ...
  assign s13_0[2] = g13_0[0] ^ g13_0[3];
  assign s13_1[2] = g13_1[0] ^ g13_1[3];
  ...
  assign s14_0[2] = g14_0[0] ^ g14_0[3];
  assign s14_1[2] = g14_1[0] ^ g14_1[3];
  ...
  assign s15_0[2] = g15_0[0] ^ g15_0[3];
  assign s15_1[2] = g15_1[0] ^ g15_1[3];
